package com.jackzeng.activiti.rest.servlet;
...
import com.jackzeng.activiti.rest.conf.ApplicationConfiguration;
...
public class WebConfigurer implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent sce) {
    ...
    SpringContextUtil.loadActCfg();
    log.debug("loading from activiti-context-cfg.xml...");
